...
#     with open("pass_vectorizer.pickle", "rb") as f:
#         ppass_vectorizer = pickle.load(f)
#     return pass_model, ppass_vectorizer
#
#
# def check_password_strength(password, pass_model, ppass_vectorizer):
#     password_vector = ppass_vectorizer.transform([password])
#     prediction = pass_model.predict(password_vector)[0]
#     if prediction == 0:
#         return "Weak"
#     elif prediction == 1:
#         return "Medium"
